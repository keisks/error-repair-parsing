...
CRFSUITE_UTIL="/PATH_TO/crfsuite-0.12/example"
crfsuite="/PATH_TO/crfsuite-0.12/bin/crfsuite"
...
python ./chunker/convert_to_conll2000.py wsj02-21.conll > wsj02-21.cnl2000
echo "converting dev data ..."
python ./chunker/convert_to_conll2000.py wsj22.conll > wsj22.cnl2000
echo "converting test data ..."
python ./chunker/convert_to_conll2000.py wsj23.conll > wsj23.cnl2000

# get features
echo "extract features (for chunking)"
echo "extracting ptb-training features"
python $CRFSUITE_UTIL/chunking.py < ./wsj02-21.cnl2000 > wsj02-21.feats
echo "extracting ptb-dev features"
python $CRFSUITE_UTIL/chunking.py < ./wsj22.cnl2000 > wsj22.feats
echo "extracting ptb-test features"
python $CRFSUITE_UTIL/chunking.py < ./wsj23.cnl2000 > wsj23.feats
...
python chunker/ptbwithchunk.py wsj02-21.conll wsj02-21.chunk > train.E00
echo "creating dev.E00"
python chunker/ptbwithchunk.py wsj22.conll wsj22.chunk > dev.E00
echo "creating test.E00"
python chunker/ptbwithchunk.py wsj23.conll wsj23.chunk > test.E00
